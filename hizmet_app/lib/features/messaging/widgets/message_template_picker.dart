...
/// Bottom sheet for picking a saved customer message template.
/// Returns the selected template text via Navigator.pop, or null if cancelled.
class MessageTemplatePickerSheet extends ConsumerWidget {
  const MessageTemplatePickerSheet({super.key});
  ...
  static Future<String?> show(BuildContext context) {
    return showModalBottomSheet<String>(
      ...
      builder: (_) => const MessageTemplatePickerSheet(),
    );
  }
