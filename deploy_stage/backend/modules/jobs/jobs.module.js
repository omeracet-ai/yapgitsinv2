...
exports.JobsModule = JobsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([job_entity_1.Job, offer_entity_1.Offer, job_question_entity_1.JobQuestion, job_question_reply_entity_1.JobQuestionReply]),
            users_module_1.UsersModule,
            tokens_module_1.TokensModule,
        ],
        providers: [jobs_service_1.JobsService, offers_service_1.OffersService, questions_service_1.QuestionsService],
