...
], ServiceRequestApplication.prototype, "tenantId", void 0);
__decorate([
...
exports.ServiceRequestApplication = ServiceRequestApplication = __decorate([
    ...
    (0, typeorm_1.Index)('idx_sr_apps_serviceRequestId_status', ['serviceRequestId', 'status']),
    (0, typeorm_1.Index)('idx_sr_apps_userId_status', ['userId', 'status'])
