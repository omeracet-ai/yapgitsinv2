...
exports.ServiceRequestsModule = ServiceRequestsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([service_request_entity_1.ServiceRequest, service_request_application_entity_1.ServiceRequestApplication, job_entity_1.Job]),
        ],
