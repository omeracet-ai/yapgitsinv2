...
__decorate([
    ...
    __metadata("design:type", Number)
], TokenTransaction.prototype, "amountMinor", void 0);
__decorate([
...
exports.TokenTransaction = TokenTransaction = __decorate([
    ...
    (0, typeorm_1.Index)('idx_token_tx_userId_createdAt', ['userId', 'createdAt']),
    (0, typeorm_1.Index)('idx_token_tx_type_status', ['type', 'status'])
], TokenTransaction);
