...
let OffersController = class OffersController {
    ...
    counter(id, body, req) {
        return this.offersService.counter(id, req.user.id, body.counterPrice, body.counterMessage, body.lineItems);
    }
    getChain(id) {
        return this.offersService.getNegotiationChain(id);
    }
    withdraw(jobId, offerId, req) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, offer_dto_1.CreateOfferDto, Object]),
...
__decorate([
    ...
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, offer_dto_1.CounterOfferDto, Object]),
    __metadata("design:returntype", void 0)
], OffersController.prototype, "counter", null);
__decorate([
    (0, common_1.Get)(':id/chain'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], OffersController.prototype, "getChain", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, common_1.Patch)(':offerId/withdraw'),
    __param(0, (0, common_1.Param)('jobId')),
    ...
    __metadata("design:returntype", void 0)
], OffersController.prototype, "withdraw", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
